...
The goal of this project is to develop a car dealership website with a dealership review service. 
- In this project we use Django and React for the web application with a SQLite database to store users information. 
