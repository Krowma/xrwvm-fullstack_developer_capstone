...
if ( curr_user !== null &&  curr_user !== "") {
    home_page_items = <div className="input_panel">
      <text className='username' style={{color: "grey"}}>{sessionStorage.getItem("username")}</text>
    <a className="nav_item" href="/djangoapp/logout" onClick={logout} style={{color: "grey"}}>Logout</a>
  </div>
}
    return (
        <div>
          <nav class="navbar navbar-expand-lg navbar-light" style={{backgroundColor:"black",height:"1in"}}>
            <div class="container-fluid">
              <h2 style={{paddingRight: "5%", color: "white"}}>Dealerships</h2>
              ...
              <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                  <li class="nav-item">
                    <a class="nav-link" style={{fontSize: "larger", color: "white"}} aria-current="page" href="/">Home</a>
                  </li>
                  <li class="nav-item">
